...
class Rule000501 extends \IBAN\Rule\DE\Rule000000
{    
    ...
    public function generateIban() {
        ...
        if(in_array($this->instituteIdentification, $partialBlockedInstituteIdentifications) && intval($this->bankAccountNumber) >= 998000000 && intval($this->bankAccountNumber) <= 999499999) {
            return "";
        }
		
        $completeBlockedInstituteIdentifications = array(
            "10045050", "50040033", "70045050",     # Gesperrte BLZ
            "10040085", "35040085", "36040085", "44040085", "50040085", "67040085", "82040085" # Sperrung beantragt in Juni 2013 Dokument
        );
